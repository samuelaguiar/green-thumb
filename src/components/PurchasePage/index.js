  ...
  render() {
    ...
    return (
      <div className="container background-white">
        ...
        <div className="container-inside align-items-center">
                ...
                <div className="contact-form">
                  ...
                  <form>
                    ...
                    >
                      ...
                      >
                        <Invalid></Invalid>
                        <span>Your name must have at least 4 letters.</span>
                      </div>
                    </div>
                    <div
                      className={`input-group ${
                        this.state.email.length > 0 && !this.state.validEmail
                          ? "invalid"
                          : ""
                      }`}
                    >
